from modules.networks.vision.scae.models.utils import geometric_transform
import numpy as np
import math
import torch
...
from modules.networks.vision.scae.models.utils import safe_log, safe_ce, index_select_nd, normalize, l2_loss
...
class CapsuleLikelihood(nn.Module):
    ...
    def forward(self, x, votes, scales, vote_presence_prob, device, presence=None):
        ...
        is_from_capsule = torch.div(winning_vote_idx, self._n_votes, rounding_mode='floor')
